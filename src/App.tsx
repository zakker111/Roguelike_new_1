...
export default function App() {
  ...
  const makeMove = (dx: number, dy: number) => {
    ...
    // Resource Harvesting (Trees, Ore Veins)
    ...
    if (enemyIndex !== -1) {
      ...
      // If companion or freed captive, swap position seamlessly so player is never trapped or blocked
  ...
  /* _oldHandleEquipItem
  const _oldHandleEquipItem = (item: EquipmentItem, hand?: 'right' | 'left') => {
    playSound('loot');
